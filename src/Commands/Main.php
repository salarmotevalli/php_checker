...
final class Main extends AbstractCommand
{
    ...
    {
        return 'do the class imports';
    }

    private function usage(): void
    {
        \print_r(value: "USAGE => \033[36m/vendor/bin/do \033[33m<optin> \033[31m[flag]\033[0m" . \PHP_EOL);
        \print_r(value: "example => \033[36m/vendor/bin/do \033[33mcheck:\033[35mimport \033[31m--file=app/http/controller/UserControler.php" . \PHP_EOL . \PHP_EOL);
    }
